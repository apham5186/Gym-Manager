...
public class FitnessClass {
  ...
  */
  ...
  /**
   * returns member array of all members particpating in the class
   * @return member array
   */
  ...
  /**
   * returns member array of all guest particpating in the class
   * @return member array
   */
  ...
  */
  ...
  public void printPartcipants() {
    ...
    * timeslot
    * @return a boolean value true if there is a class conflict, otherwise false.
    */
